...
def Base1_RCM_triCNN_combined_10000_retraining():
    ### where to save the 3-fold CV validation acc

    ### where to save the retrained model
    model_folder = '/home/wangc90/circRNA/circRNA_Data/model_outputs/Combined_model1_retraining/Combined_model1_retraining_10000'
    ...
    retraining(model=Base1_RCM_triCNN_combined_10000, dataset=BS_LS_dataset, model_folder=model_folder)

Base1_RCM_triCNN_combined_10000_retraining()